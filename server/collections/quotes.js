...
Quotes.before.update(function(userId, doc, fieldNames, modifier, options) {
...
Quotes.before.upsert(function(userId, selector, modifier, options) {
	modifier.$set = modifier.$set || {};
	modifier.$set.modifiedAt = new Date();
	modifier.$set.modifiedBy = userId;
...
Quotes.before.remove(function(userId, doc) {
